...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.video_frame, 0, 0, 1, 3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.start_button.setText(_translate("MainWindow", "视频播放 / 暂停"))
